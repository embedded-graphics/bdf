...
fn main() {
    ...
    let font_6x10 = FontConverter::new("examples/6x10.bdf", "FONT_6X10")
        //.file_stem("font_6x10")
    ...
    let font_10x20 = FontConverter::new("examples/10x20.bdf", "FONT_10X20")
    ...
    let font_6x10 = FontConverter::new("examples/6x10.bdf", "FONT_6X10_MONO")
    ...
    let font_10x20 = FontConverter::new("examples/10x20.bdf", "FONT_10X20_MONO")
